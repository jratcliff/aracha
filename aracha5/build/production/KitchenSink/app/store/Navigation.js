        ...
        return this.addIconClasses([
            {
                ...
                expanded: true,
                children: [
                    { id: 'themeViewer', text: 'Theme Viewer', leaf: true }
                ]
            },
            {
                text: 'Aracha UX',
                ...
                expanded: true,
                children: [
                    { id: 'aracha-fileuploads-grid', text: 'File Drop Grid', leaf: true },
                    { id: 'aracha-fileuploads-dataview', text: 'File Drop DataView', leaf: true },
                    { id: 'aracha-fileuploads-manager', text: 'File Drop Manager', leaf: true }
                ]
            },
            {
                text: 'Panels',
