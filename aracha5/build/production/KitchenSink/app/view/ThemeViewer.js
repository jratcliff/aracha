/**
 * This is a copy of the Theme Viewer example app in examples/themes/theme.js
 * with a few modifications so that it will run in the KitchenSink app
 */
(function () {

    Ext.define('KitchenSink.view.ThemeViewer', {
    ...
    // copied from examples/themes/themes.js
    Ext.require([
        'Ext.PluginManager',
        'Ext.window.Window',
        'Ext.panel.Panel',
    ...
    var sizing = {
        mainContainer: {
            'ext-theme-classic': [1130, 1460],
            'ext-theme-neptune': [1250, 1600],
            'ext-theme-neptune-touch': [790, 4140]
        },
        basicPanel: {
            'ext-theme-classic': [150, 90, 20, 20],
            'ext-theme-neptune': [150, 130, 20, 20],
            'ext-theme-neptune-touch': [250, 150, 0, 0]
        },
        collapsedPanel: {
            'ext-theme-classic': [150, 70, 20, 120],
            'ext-theme-neptune': [150, 120, 20, 160],
            'ext-theme-neptune-touch': [250, 150, 0, 170]
        },
        maskedPanel: {
            'ext-theme-classic': [130, 170, 180, 20],
            'ext-theme-neptune': [130, 260, 180, 20],
            'ext-theme-neptune-touch': [230, 320, 270, 0]
        },
        framedPanel: {
            'ext-theme-classic': [170, 100, 320, 20],
            'ext-theme-neptune': [200, 150, 320, 20],
            'ext-theme-neptune-touch': [270, 150, 520, 0]
        },
        collapsedFramedPanel: {
            'ext-theme-classic': [170, 60, 320, 130],
            'ext-theme-neptune': [200, 100, 320, 180],
            'ext-theme-neptune-touch': [270, 150, 520, 170]
        },
        basicWindow: {
            'ext-theme-classic': [150, 170, 500, 20, {
                minWidth: 150,
                minHeight: 150,
                maxHeight: 170
            }],
            'ext-theme-neptune': [150, 260, 530, 20, {
                minWidth: 150,
                minHeight: 200,
                maxHeight: 260
            }],
            'ext-theme-neptune-touch': [250, 260, 0, 340, {
                minWidth: 150,
                minHeight: 200,
                maxHeight: 260
            }]
        ...
        panelWithToolbars: {
            'ext-theme-classic': [450, 170, 660, 20],
            'ext-theme-neptune': [500, 260, 690, 20],
            'ext-theme-neptune-touch': [520, 260, 270, 340]
        },
        formWidgets: {
            'ext-theme-classic': [630, 750, 20, 200],
            'ext-theme-neptune': [660, 750, 20, 290],
            'ext-theme-neptune-touch': [790, 940, 0, 620]
        },
        borderLayout: {
            'ext-theme-classic': [450, 350, 660, 200],
            'ext-theme-neptune': [500, 350, 690, 290],
            'ext-theme-neptune-touch': [790, 500, 0, 1580]
        },
        grid: {
            'ext-theme-classic': [450, 200, 660, 560],
            'ext-theme-neptune': [500, 200, 690, 650],
            'ext-theme-neptune-touch': [790, 400, 0, 2100]
        },
        accordion: {
            'ext-theme-classic': [450, 240, 660, 770],
            'ext-theme-neptune': [500, 240, 690, 860],
            'ext-theme-neptune-touch': [790, 340, 0, 2520]
        },
        scrollingTabs: {
            'ext-theme-classic': [310, 150, 20, 960],
            'ext-theme-neptune': [325, 150, 20, 1050],
            'ext-theme-neptune-touch': [420, 200, 0, 2880]
        },
        plainTabs: {
            'ext-theme-classic': [310, 150, 340, 960],
            'ext-theme-neptune': [325, 150, 355, 1050],
            'ext-theme-neptune-touch': [350, 200, 440, 2880]
        },
        datePicker: {
            'ext-theme-classic': [180, undefined, 20, 1120],
            'ext-theme-neptune': [212, undefined, 20, 1210],
            'ext-theme-neptune-touch': [282, undefined, 0, 3780]
        },
        progressBar: {
            'ext-theme-classic': [450, 200, 660, 1020],
            'ext-theme-neptune': [500, 200, 690, 1110],
            'ext-theme-neptune-touch': [790, 340, 0, 3100]
        },
        framedGrid: {
            'ext-theme-classic': [450, 180, 660, 1230],
            'ext-theme-neptune': [500, 180, 690, 1320],
            'ext-theme-neptune-touch': [790, 300, 0, 3460]
        },
        resizer: {
            'ext-theme-classic': [440, 220, 210, 1120],
            'ext-theme-neptune': [440, 220, 240, 1210],
            'ext-theme-neptune-touch': [488, 314, 302, 3780]
        }
    };
    ...
    function getSizing(id) {
        ...
        if (theme === 'ext-theme-gray') {
            // same dimensions
            theme = 'ext-theme-classic';
        }

        info = sizing[id][theme];
        if (!info && theme === 'ext-theme-crisp') {
            // default to neptune for crisp
            info = sizing[id]['ext-theme-neptune'];
        }
        if (!info && theme === 'ext-theme-crisp-touch') {
            // default to neptune-touch for crisp
            info = sizing[id]['ext-theme-neptune-touch'];
        }

        // use the neptune theme as the default for all themes not found
        if (!info) {
            // default to neptune-touch for crisp
            info = sizing[id]['ext-theme-neptune'];
        }
