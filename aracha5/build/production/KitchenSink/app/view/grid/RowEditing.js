/**
 * This example shows how to enable users to edit the contents of a grid using a row editor.
 */
Ext.define('KitchenSink.view.grid.RowEditing', {
    ...
    //<example>
    exampleTitle: 'Row Editing Grid Example',
    otherContent: [{
        type: 'Model',
    ...
    initComponent: function() {
        ...
        if (Ext.supports.Touch) {
            this.addDocked({
                xtype: 'header',
                title: '<b>Note that row editing is not recommeded on keyboardless touch devices.</b>'
            });
        }
